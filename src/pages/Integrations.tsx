...
const integrations = [
  { name: "Google Search Console", icon: Search, status: "Connected", category: "Search Data", color: "text-blue-400", bgColor: "bg-blue-500/10" },
  { name: "HubSpot CRM", icon: Users, status: "Not Connected", category: "Revenue Operations", color: "text-orange-400", bgColor: "bg-orange-500/10" },
  { name: "Notion", icon: FileText, status: "Coming Soon", category: "Workspace Sync", color: "text-slate-400", bgColor: "bg-slate-500/10" },
  { name: "Ahrefs", icon: Globe, status: "Not Connected", category: "Backlink Intelligence", color: "text-cyan-400", bgColor: "bg-cyan-500/10" },
  { name: "Slack", icon: MessageSquare, status: "Connected", category: "Real-time Alerts", color: "text-purple-400", bgColor: "bg-purple-500/10" },
