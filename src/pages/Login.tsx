        ...
        >
          ...
          {!isLogin && (
            <div className="flex items-center justify-between mt-8 relative z-10">
              <div className="flex items-center gap-2">
                <div className="h-1 w-8 bg-cyan-400 rounded-full shadow-[0_0_8px_rgba(0,212,255,0.5)]" />
                <div className="h-1 w-2 bg-white/20 rounded-full" />
                <div className="h-1 w-2 bg-white/20 rounded-full" />
                <div className="h-1 w-2 bg-white/20 rounded-full" />
              </div>
              <span className="text-[10px] font-bold tracking-widest text-[#8ba3c7] uppercase">Step 1 of 4</span>
            </div>
          )}
